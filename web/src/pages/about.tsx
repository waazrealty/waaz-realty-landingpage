...
export default function About({teams}: {teams : Team[]}) {
  ...
  return (
    <BasicLayout title="About Us | Waaz Realty" description="Learn about Waaz Realty and our commitment to premium real estate in Lagos." canonical={canonical} url={canonical} image="/assets/about-preview.png">
      ...
      <section
        className="w-full flex flex-col items-center md:space-y-6"
      >
        <div className="flex lg:w-full w-11/12 items-center justify-center md:gap-5 gap-3 md:text-[3.35rem] text-4xl text-center leading-16 italic font-serif">
        ...
        <div className="text-[#666D80] lg:w-135 w-11/12 md:text-justify text-center text-base leading-7 md:mb-5 mb-10">
      ...
      >
        <div className="flex md:flex-row flex-col md:items-center md:justify-end justify-center md:space-x-50 md:space-y-0 space-y-5 lg:w-10/12 w-11/12">
        ...
        <div className="flex flex-col md:items-end md:justify-end space-x-25 md:space-y-0 space-y-5 lg:w-10/12 w-11/12">
              ...
              {teams.map((team) => {
                ...
                <div key={team._id} className="snap-center shrink-0 md:max-w-75 w-full overflow-hidden">
                  ...
                  <div className="md:space-y-1 md:py-6 py-2">
                    <p className="text-base text-black font-medium">{team.name}</p>
                    <h3 className="text-sm text-[#666D80] font-medium">{team.role}</h3>
                  </div>
                </div>
              )})}
            </div>
