...
export default function ListYourProperty() {
  ...
  return (
    <BasicLayout
      title="List Your Property | Waaz Realty"
      description="Get in touch with Waaz Realty for property inquiries and support."
      canonical={canonical}
      url={canonical}
      image="/assets/contact-preview.png"
    >
      <section className="relative lg:w-10/12 w-11/12 lg:mt-15 mt-20">
        <div className="absolute inset-0">
          ...
          />
          <div
            className="block md:hidden h-160 w-full bg-cover bg-center rounded-4xl"
            style={{ backgroundImage: "url('/assets/images/bg-listing.png')" }}
            aria-hidden="true"
          />
        </div>
        ...
        <div className="relative mx-auto md:p-10 p-5 lg:w-[38%] md:w-10/12 w-11/12 bg-[#F6F8FA] border border-[#ECEFF3] rounded-4xl -mb-100">
        {isSubmitted ? (
          <div className="mt-6 flex flex-col items-center space-y-10 my-10">
            <img src="/assets/images/success.gif" alt="Waaz Realty Logo" className="h-25 w-25" />
            <p className="text-4xl text-center font-serif font-medium italic">Property Submitted</p>
          </div>
          ) : (
            <div>
              ...
              <div className="mt-6 space-y-6 font-medium">
                  ...
                  <div className="grid grid-cols-2 w-full gap-3">
                    {['Property Owner', 'Real Estate Agent'].map((type) => (
                      <div
                        ...
                        className={`w-full flex flex-row gap-2 items-center px-2 py-3 md:text-sm text-xs outline-none transition rounded-lg cursor-pointer ${
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-[#506437] focus:ring-2 focus:ring-[#E6ECD9] rounded-lg"
                  />
                </div>
            ...
            {step === 2 && (
              <div className="mt-6 space-y-6 font-medium">
                ...
                <div>
                  ...
                  <div className="flex flex-row items-center justify-between w-full bg-white px-4 py-3 rounded-lg">
                    <input
                      type="text"
